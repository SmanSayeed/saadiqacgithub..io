...
class Gallery_Controller extends CI_Controller {
	...
	{	
		...
		$data=array();
		$data['admin_main_content']=$this->load->view('admin_part/functions/gallery/add_image','',true);
	...
	{	
		...
		$this->Gallery_model->save_gallery();
	}
	...
	{	
		$data=array();
			...
			$data['admin_main_content']=$this->load->view('admin_part/functions/gallery/gallery_list',$data,true);
			$this->load->view('admin_part/dashboard',$data);
	}
