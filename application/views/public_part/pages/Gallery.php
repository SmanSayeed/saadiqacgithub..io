...
<html lang="en">
	...
	<head>
	    ...
	    <!--[if lt IE 9]>
		    <script src="<?php echo base_url(); ?>assets/frontend/js/vendor/html5shim.js"></script>
						...
						<div class="container">
							...
							<div class="collapse navbar-collapse navbar-collapse">
								<ul class="nav navbar-nav navbar-right ">
									...
									<li><a class="page-scroll" href="<?php echo base_url();?>">QAC</a></li>
									<li><a class="page-scroll" href="<?php echo base_url();?>">IQAC</a></li>
									<li><a class="page-scroll" href="<?php echo base_url();?>">OBJECTIVES</a></li>
									<li><a class="page-scroll" href="<?php echo base_url();?>">FUNCTIONS</a>
										<ul>
								      		<li><a class="page-scroll"  href="<?php echo base_url();?>">ACTIVITIES</a></li>
								      		<li><a class="page-scroll" href="<?php echo base_url();?>" style="text-align: left">MATERIALS AND DOWNLOAD</a></li>
		      							</ul>
									</li>
