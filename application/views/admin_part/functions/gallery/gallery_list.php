...
<?php 
					...
					?>
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
						  <?php 
						  	foreach ($show_all_images as $v_img) {
						  		?>
						  		<tr>
								...
								<td class="center">
									...
									<a class="btn btn-info" href="<?php echo base_url()?>edit-gallery/<?php echo $v_img->id;?>">
										<i class="halflings-icon white edit"></i>  
									</a>
									<a class="btn btn-danger" id="delete" href="<?php echo base_url()?>delete-gallery/<?php echo $v_img->id;?>">
